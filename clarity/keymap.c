...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+------+------+------+------|                |------+------+-------+------+-------+--------|
     KC_Q,     CM_A,  CM_R,  CM_S,  CM_T,  KC_G,                KC_M,  CM_N,  CM_E,  CM_I,  CM_O, KC_SCLN,
  //|------+------+------+------+------+------|                |------+------+-------+------+-------+--------|
  ...
  //,---------------------------------------------.                ,-----------------------------------------.
     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                   KC_NO, KC_DEL,KC_CAPS,KC_INS, KC_PSCR, KC_NO,
  //|------+------+-------+-------+-------+-------|                |------+------+------+------+------+------|
     KC_NO, KC_LALT, KC_LGUI, KC_LCTL, KC_LSFT, KC_NO,           KC_NO, KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT, KC_NO,
  //|------+------+-------+-------+-------+-------|                |------+------+------+------+------+------|
     KC_NO, KC_NO, KC_NO, KC_NO, TG(_OUTER_L_LK), KC_NO,         KC_NO, KC_HOME,KC_PGDN,KC_PGUP,KC_END, KC_NO,
  //|------+------+-------+-------+-------+-------+------|  |------+------+------+------+------+------+------|
                                KC_NO, KC_TRNS, KC_TRNS,        KC_TILD, LT(_OUTER_R,KC_PAST), KC_NO
                                  //`--------------------'  `--------------------'
  ),
  ...
  //,---------------------------------------------.                ,-----------------------------------------.
    KC_NO, KC_BTN2, KC_BTN3, HLD_BTN1, KC_BTN1, KC_V,       KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO, KC_NO,
  //|------+------+-------+-------+-------+-------|                |------+------+------+------+------+------|
    KC_NO, KC_MS_L, KC_MS_U, KC_MS_D, KC_MS_R, KC_C,        KC_NO,KC_RSFT,KC_RCTL,KC_RGUI, KC_LALT, KC_NO,
  //|------+------+-------+-------+-------+-------|                |------+------+------+------+------+------|
    KC_NO, KC_WH_L, KC_WH_U, KC_WH_D, KC_WH_R, KC_X,        KC_NO,TG(_OUTER_R_LK),KC_NO,KC_NO, KC_NO, KC_NO,
  //|------+------+-------+-------+-------+-------+------|  |------+------+------+------+------+------+------|
                 KC_NO, LT(_OUTER_L,KC_ESC), KC_COLN,           KC_TRNS, KC_TRNS, KC_NO
                                  //`--------------------'  `--------------------'
  ),
  ...
  //,---------------------------------------------.                ,-----------------------------------------.
     KC_NO, KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,               KC_AT,  KC_HASH,KC_LCBR, KC_RCBR, KC_GRAVE, KC_NO,
  //|------+-------+----+------+------+-------|           +------+--+------------+----+------+------+----+-+------|
     KC_NO, KC_LALT, KC_LGUI, KC_LCTL, KC_LSFT, KC_NO,   KC_EXLM,KC_DQUO,KC_LPRN, KC_RPRN, KC_UNDS, KC_NO,
  //|------+-------+----+------+------+-------|           +------+--+------------+----+------+------+----+-+------|
     KC_NO, KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,               KC_AMPR,KC_QUOT,KC_LBRC, KC_RBRC, KC_MINS, KC_NO,
  //|------+------+-------+-------+-------+-------+------|  |------+------+------+------+------+------+------|
  ...
  //,---------------------------------------------.                ,-----------------------------------------.
    KC_NO, KC_GRAVE, KC_1, KC_2, KC_3, KC_COMM,                 KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO, KC_NO,
  // |------+------+------+------+------+----------|                |------+------+------+------+------+------|
    KC_NO, KC_SPC,  KC_4, KC_5, KC_6, KC_0,                     KC_NO, KC_RSFT,KC_RCTL,KC_RGUI, KC_LALT, KC_NO,
  // |------+------+------+------+------+----------|                |------+------+------+------+------+------|
    KC_NO, KC_BSLS, KC_7, KC_8, KC_9, KC_DOT,                   KC_NO,KC_NO,KC_NO,KC_NO, KC_NO, KC_NO,
  //|------+------+-------+-------+-------+-------+------|  |------+------+------+------+------+------+------|
                    KC_NO, OSL(_INNER_R2), OSL(_INNER_R1),       KC_TRNS, KC_TRNS, KC_NO
                                  //`--------------------'  `--------------------'
  ),
  ...
  //,---------------------------------------------.        ,-----------------------------------------.
     KC_NO, KC_F1, KC_F2, KC_F3, KC_F4,KC_NUM,             KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_NO,
  //|------+-----+-------+-------+----+------|             +------+-------+-------+-------+---------|
     KC_NO, KC_F5, KC_F6, KC_F7, KC_F8,KC_PAUS,            KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_NO,
  //|------+-----+-------+-------+----+------|             +------+-------+-------+-------+---------|
     KC_NO, KC_F9, KC_F10,KC_F11,KC_F12,KC_SCRL,            KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_NO,
  //|------+------+-------+-------+-------+-------+------|  |------+------+------+------+------+------+------|
                                KC_NO, KC_TRNS, KC_TRNS,         KC_TRNS, TO(0), KC_NO
                                  //`--------------------'  `--------------------'
  ),
  ...
  //,---------------------------------------------.                ,-----------------------------------------.
     KC_NO, KC_CIRC, KC_PERC, KC_DLR, KC_HASH, KC_AT,            KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_NO,
  //|------+------+-------+-------+-------+-------|              +------+-------+-------+-------+---------|
     KC_NO, KC_ASTR, KC_MINS, KC_PLUS, KC_EQL, KC_EXLM,          KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_NO,
  //|------+------+-------+-------+-------+-------|              +------+-------+-------+-------+---------|
     KC_NO, KC_SLSH, KC_PIPE, KC_LT, KC_GT, KC_AMPR,             KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_NO,
  //|------+------+-------+-------+-------+-------+------|  |------+------+------+------+------+------+------|
                                KC_NO, KC_TRNS, KC_TRNS,     KC_TRNS, TO(0), KC_NO
                                  //`--------------------'  `--------------------'
  ),
  ...
  //,-----------------------------------------.                ,-----------------------------------------.
    KC_NO,TG(_STINGS),TG(_GAME1),DF(_QWERTY),DF(_CMAK),KC_NO,  KC_NO, TM_SPC, TM_S, TM_V, TM_X, KC_NO,
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                  TM_PLUS, TM_ON, TM_SCON, TM_C, TM_AMPR, KC_NO,
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    KC_NO, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY, KC_NO,          TM_MINS, TM_LT, TM_P, TM_N, TM_GT, KC_NO,
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
  ...
  //,-----------------------------------------.                ,-----------------------------------------.
    KC_NO, RESET,RGBRST, KC_NO, KC_NO, KC_NO,                     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    KC_NO, RGB_TOG,RGB_HUI,RGB_SAI,RGB_VAI,RGB_SPI,               KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    KC_NO, RGB_MOD,RGB_HUD,RGB_SAD,RGB_VAD,RGB_SPD,               KC_NO, KC_NO, KC_NO, KC_NO, RGB_RMOD, KC_NO,
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                KC_NO, KC_NO, KC_NO,    KC_NO, TO(0), KC_NO
                              //`--------------------'  `--------------------'
  ),
  ...
  //|------+------+------+------+------+------|                |------+------+-------+------+-------+--------|
     KC_NO, KC_A,  KC_S,  KC_D,  KC_F,  KC_G,                KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
  //|------+------+------+------+------+------|                |------+------+-------+------+-------+--------|
     KC_NO,  KC_Z,  KC_X,  KC_C,  KC_V,  KC_B,               KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
  //|------+------+------+------+------+------+------|  |------+------+------+-------+------+-------+--------|
                           KC_NO, KC_LCTL, TT(_GAME2),  KC_NO, TO(0), KC_NO
                              //`--------------------'  `--------------------'
  ),
  ...
  //|------+------+------+------+------+------|                |------+------+-------+------+-------+--------|
     KC_NO, KC_NO,  KC_4,  KC_5,  KC_6,  KC_0,                 KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
  //|------+------+------+------+------+------|                |------+------+-------+------+-------+--------|
     KC_NO,  KC_NO, KC_7,  KC_8,  KC_9,  KC_NO,                KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
  //|------+------+------+------+------+------+------|  |------+------+------+-------+------+-------+--------|
                            KC_NO, KC_LCTL, KC_TRNS,    KC_NO, TO(0), KC_NO
                              //`--------------------'  `--------------------'
  )
